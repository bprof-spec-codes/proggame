...
{
    [DbContext(typeof(proggameDbContext))]
    partial class proggameDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proggame.Entities.SolutionFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSolutions", "dbo");
                });

            modelBuilder.Entity("proggame.Entities.TaskFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTasks", "dbo");
                });

            modelBuilder.Entity("proggame.Entities.TestFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("proggame.Entities.SolutionFile", b =>
                {
                    ...
                    b.HasOne("proggame.Entities.TaskFile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("proggame.Entities.TestFile", b =>
                {
                    ...
                    b.HasOne("proggame.Entities.TaskFile", "Task")
                        .WithMany()
